...
var _verifySession = _interopRequireDefault(require("./backend/app/auth/verifySession"));
...
app.use("".concat(process.env.api_base_url, "/users"), _passport["default"].authenticate('jwt', {
  session: false
}), _users["default"]);
app.use("".concat(process.env.api_base_url, "/events"), _passport["default"].authenticate('jwt', {
  session: false
}), _events["default"]);
