...
var actions = {
  createFeedback: function createFeedback(_ref) {
  ...
  geAllFeedback: function geAllFeedback(_ref2) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 1;
              _context2.next = 4;
              return feedbackService.geAllFeedback(payload);
  ...
  deleteFeedback: function deleteFeedback(_ref3) {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.prev = 1;
              _context3.next = 4;
              return feedbackService.deleteFeedback(payload);
